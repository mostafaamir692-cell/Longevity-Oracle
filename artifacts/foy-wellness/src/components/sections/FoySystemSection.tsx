  ...
  return (
    <section id="system" className="py-24 bg-muted/30 relative z-10 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-border rounded-3xl overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.4)]">
          {steps.map((step, idx) => (
            <FadeIn key={idx} delay={idx * 0.1}>
              <div className="group bg-card p-10 hover:bg-primary/5 transition-colors duration-300 relative overflow-hidden">
                <span className="absolute right-6 bottom-4 text-8xl font-display font-bold text-primary/5 select-none pointer-events-none leading-none group-hover:text-primary/10 transition-colors duration-300">
                  {step.num}
                </span>

                <div className="relative z-10 flex items-start gap-5">
                  <div className="shrink-0 w-10 h-10 rounded-2xl bg-primary/8 border border-primary/20 flex items-center justify-center group-hover:bg-primary group-hover:border-primary group-hover:shadow-[0_0_16px_rgba(16,185,171,0.4)] transition-all duration-300">
                  ...
                  <div>
                    <h3 className="font-bold text-lg text-foreground/90 mb-2 group-hover:text-primary group-hover:text-glow transition-all duration-300">{step.title}</h3>
        ...
        <FadeIn delay={0.5} className="mt-8">
          <div className="flex items-center gap-3 px-6 py-4 rounded-2xl bg-card border border-border w-fit">
            <div className="w-2 h-2 rounded-full bg-primary animate-pulse shadow-[0_0_8px_rgba(16,185,171,0.8)]" />

...
const inputClass =
  "w-full bg-input border border-border rounded-xl px-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all text-sm";
...
export function BookingSection() {
  ...
  return (
    <section id="booking" className="py-24 bg-muted/40 relative z-10 border-t border-border">
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <FadeIn>
            <span className="text-primary font-semibold tracking-widest uppercase text-xs mb-5 block">Book a Consultation</span>
            ...
            <div className="p-6 bg-card border border-border rounded-2xl">
              ...
              <p className="text-sm text-primary mt-2 font-medium">+20 100 000 0000 &nbsp;·&nbsp; clinic@foyclinic.com</p>
            </div>
          </FadeIn>
            ...
            <div className="bg-card border border-border rounded-3xl p-8 md:p-10 shadow-sm">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  <div>
                    <label className="block text-xs font-semibold text-foreground/70 uppercase tracking-wider mb-2">Full Name</label>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-foreground/70 uppercase tracking-wider mb-2">Program of Interest</label>
                    <select {...register("serviceId")} className={inputClass + " appearance-none bg-input"}>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-foreground/70 uppercase tracking-wider mb-2">Message (Optional)</label>
                    <textarea
                      {...register("message")}
                      rows={3}
